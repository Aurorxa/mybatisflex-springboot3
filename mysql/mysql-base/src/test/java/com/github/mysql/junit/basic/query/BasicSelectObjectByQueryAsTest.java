...
class BasicSelectObjectByQueryAsTest {
    ...
    @Test
    void testSelectObjectByQueryAs() {
        ...
        log.info("BasicSelectObjectByQueryAsTest.testSelectObjectByQueryAs.size ==> {}", size);
        ...
        Long id = accountMapper.selectObjectByQueryAs(queryWrapper, Long.class);

        log.info("BasicSelectObjectByQueryAsTest.testSelectObjectByQueryAs.id ==> {}", id);
