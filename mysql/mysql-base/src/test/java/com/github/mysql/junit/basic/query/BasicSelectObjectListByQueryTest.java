...
class BasicSelectObjectListByQueryTest {
    ...
    void testSelectObjectListByQuery() {
        ...
        log.info("BasicSelectObjectListByQueryTest.testSelectObjectListByQuery.size ==> {}", size);
        ...
        List<Object> idList = accountMapper.selectObjectListByQuery(queryWrapper);

        log.info("BasicSelectObjectListByQueryTest.testSelectObjectListByQuery.idList==> {}", idList);
